...
public class EventActivity extends AppCompatActivity {
    ...
    public RadioButton pubg;
    public RadioButton fifa;
    public RadioButton mini;
    public RadioButton csgo;
    public RadioButton rolls;
    public RadioButton deserts;
    public RadioButton burger;
    public RadioButton pizza;
    public RadioButton dance;
    public RadioButton song;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pubg = (RadioButton) findViewById(R.id.checkBox1);
        fifa = (RadioButton) findViewById(R.id.checkBox2);
        mini = (RadioButton) findViewById(R.id.checkBox3);
        csgo = (RadioButton) findViewById(R.id.checkBox4);
        rolls = (RadioButton) findViewById(R.id.checkBox21);
        deserts = (RadioButton) findViewById(R.id.checkBox22);
        burger = (RadioButton) findViewById(R.id.checkBox23);
        pizza = (RadioButton) findViewById(R.id.checkBox24);
        dance = (RadioButton) findViewById(R.id.checkBox31);
        song = (RadioButton) findViewById(R.id.checkBox32);
        comedy = (RadioButton) findViewById(R.id.checkBox33);
        dj = (RadioButton) findViewById(R.id.checkBox34);
