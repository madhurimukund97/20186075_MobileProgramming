...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "callback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                String previousCallback = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(previousCallback);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState){
        ...
        String lifecycleDisplay = mLifecycleDisplay.getText().toString();
