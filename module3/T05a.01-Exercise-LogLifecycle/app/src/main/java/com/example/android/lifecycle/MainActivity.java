...
public class MainActivity extends AppCompatActivity {
     ...
     *
     * Followed by onStart() if the activity comes to the foreground, or onStop() if it becomes
     * hidden.
     */
    @Override
     ...
     * Called when the activity is becoming visible to the user.
     *
     * Followed by onPause() if the activity comes to the foreground, or onStop() if it becomes
     * hidden.
     */
    @Override
     ...
     * Called when the activity is becoming visible to the user.
     *
     * Followed by onStop() if the activity comes to the foreground, or onStop() if it becomes
     * hidden.
     */
    @Override
     ...
     * Called when the activity is becoming visible to the user.
     *
     * Followed by onRestart() if the activity comes to the foreground, or onStop() if it becomes
     * hidden.
     */
    @Override
     ...
     * Called when the activity is becoming visible to the user.
     *
     * Followed by onDestroy() if the activity comes to the foreground, or onStop() if it becomes
     * hidden.
     */
    @Override
