...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(url)) {
                String queryUrl = savedInstanceState.getString(url);
                mUrlDisplayTextView.setText(queryUrl);
            }

            if (savedInstanceState.containsKey(raw_json)) {
                String rawJson = savedInstanceState.getString(raw_json);
    ...
    public void onSaveInstanceState(Bundle outState){
        ...
        String urlVariable = mUrlDisplayTextView.getText().toString();
        outState.putString(url, urlVariable);
        String jsonResults = mSearchResultsTextView.getText().toString();
        outState.putString(raw_json, urlVariable);
